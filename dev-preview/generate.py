    ...
    (function () {
      ...
      var DATA = {
        ...
        Proposed_Tasks_Report: [
          { ID: "TK7001", Task_Name: "Checkout currency switcher", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "UI + API for currency selection.", Estimated_Hours: "6", Status: "Approved", Priority: "High", Owner: L("Priya Nair", "OW1"), Percent: "55", Rejection_Reason: "" },
          { ID: "TK7002", Task_Name: "FX rate caching layer", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "Cache FX rates for 1h.", Estimated_Hours: "4", Status: "Draft", Priority: "Medium", Owner: L("Arun Kumar", "OW2"), Percent: "0", Rejection_Reason: "" },
          { ID: "TK7003", Task_Name: "SEO meta rewrite", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5002", "RQ5002"), Description: "Rewrite meta titles/descriptions.", Estimated_Hours: "3", Status: "Pending Approval", Priority: "Medium", Owner: L("Priya Nair", "OW1"), Percent: "0", Rejection_Reason: "" },
          { ID: "TK7004", Task_Name: "Sitemap + robots audit", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5002", "RQ5002"), Description: "Regenerate sitemap, fix robots.", Estimated_Hours: "2", Status: "Pending Completion Approval", Priority: "Low", Owner: L("Arun Kumar", "OW2"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7005", Task_Name: "Notification queue schema", Project: L("Mobile App v2", "PR02"), Requirement: L("RQ5003", "RQ5003"), Description: "Design DB schema.", Estimated_Hours: "5", Status: "Closed", Priority: "High", Owner: L("Priya Nair", "OW1"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7006", Task_Name: "CMS content freeze plan", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5004", "RQ5004"), Description: "Plan freeze window.", Estimated_Hours: "2", Status: "Rework Required", Priority: "Low", Owner: L("Arun Kumar", "OW2"), Percent: "10", Rejection_Reason: "Timing conflicts with campaign" },
          { ID: "TK7007", Task_Name: "Deep-link routing", Project: L("Mobile App v2", "PR02"), Requirement: L("RQ5003", "RQ5003"), Description: "Universal links.", Estimated_Hours: "4", Status: "Not Started" /* legacy → Pending Approval */, Priority: "High", Owner: L("Priya Nair", "OW1"), Percent: "0", Rejection_Reason: "" },
          { ID: "TK7008", Task_Name: "Checkout E2E test suite", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "Automated end-to-end coverage.", Estimated_Hours: "30", Status: "Closed", Priority: "High", Owner: L("Arun Kumar", "OW2"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7009", Task_Name: "Performance budget audit", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "Lighthouse + bundle analysis.", Estimated_Hours: "10", Status: "Closed", Priority: "Medium", Owner: L("Priya Nair", "OW1"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7010", Task_Name: "API gateway setup", Project: L("API Integrations", "PR06"), Requirement: L("RQ5005", "RQ5005"), Description: "Razorpay + Stripe webhooks.", Estimated_Hours: "12", Status: "Closed", Priority: "High", Owner: L("Arun Kumar", "OW2"), Percent: "100", Rejection_Reason: "" }
        ],
        Pricing_Report: [
