    ...
    (function () {
      ...
      var DATA = {
        ...
        Proposed_Tasks_Report: [
          ...
          { ID: "TK7008", Task_Name: "Checkout E2E test suite", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "Automated end-to-end coverage.", Estimated_Hours: "30", Status: "Completion Approved", Priority: "High", Owner: L("Arun Kumar", "OW2"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7009", Task_Name: "Performance budget audit", Project: L("Website Redesign", "PR01"), Requirement: L("RQ5001", "RQ5001"), Description: "Lighthouse + bundle analysis.", Estimated_Hours: "10", Status: "Completion Approved", Priority: "Medium", Owner: L("Priya Nair", "OW1"), Percent: "100", Rejection_Reason: "" },
          { ID: "TK7010", Task_Name: "API gateway setup", Project: L("API Integrations", "PR06"), Requirement: L("RQ5005", "RQ5005"), Description: "Razorpay + Stripe webhooks.", Estimated_Hours: "12", Status: "Completion Approved", Priority: "High", Owner: L("Arun Kumar", "OW2"), Percent: "100", Rejection_Reason: "" }
        ],
        Pricing_Report: [
